...
class SettingsAudio (val Cont : Context) {
   ...
   // private var outputFile: String = Environment.getExternalStorageDirectory().absolutePath
    ...
    fun recordaudio(outputFile: String) {
        try {
            ...
            Toast.makeText(context, "Error Record:" + ex.message, Toast.LENGTH_LONG).show()
        }
    }
    ...
    fun stoprecord() {
        try {
            ...
            Toast.makeText(context, "Error Stop:" + ex.message, Toast.LENGTH_LONG).show()
        }
    }*/
    ...
    fun playaudio(outputFile: String) {
        try {
            ...
            Toast.makeText(context, "Error Play Audio:" + ex.message, Toast.LENGTH_LONG).show()
        }
    }
    fun getDuration(): Int{
    ...
    fun stopaudio(){
        try{
            ...
            Toast.makeText(context, "Error Stop Audio:"+ex.message, Toast.LENGTH_LONG).show()
        }
    }
